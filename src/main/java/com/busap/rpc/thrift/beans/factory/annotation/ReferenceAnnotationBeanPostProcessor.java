...
import static org.springframework.core.annotation.AnnotatedElementUtils.getAnnotationAttributes;;
/**
    ...
    private List<InjectionMetadata.InjectedElement> findMethodReferenceMetadata(final Class<?> beanClass) {
        ...
        ReflectionUtils.doWithMethods(beanClass, new ReflectionUtils.MethodCallback() {
            ...
            public void doWith(Method method) throws IllegalArgumentException, IllegalAccessException {
                ...
                Reference reference =bridgedMethod.getAnnotation(Reference.class);
