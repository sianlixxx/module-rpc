...
/**
 * 
 * @Title: PackagesToScanUtil.java
 * @Package com.busap.cctv.api.server.code
 * @author jecc
 * @date 2017-9-11 下午6:12:58
 * @description:
 * @version v1.0
 */
public class PackagesToScanUtil {
	private static final Logger logger =LoggerFactory.getLogger(PackagesToScanUtil.class);
